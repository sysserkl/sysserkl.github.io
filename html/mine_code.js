...
function buttons_klmine(){
    ...
    buttons=buttons+'<a href="javascript:void(null);" onclick="javascript:list_klmine(0);first_klmine();" class=aclick>Easy</a> ';
    buttons=buttons+'<a href="javascript:void(null);" onclick="javascript:list_klmine(1);first_klmine();" class=aclick>Middle</a> ';
    buttons=buttons+'<a href="javascript:void(null);" onclick="javascript:list_klmine(2);first_klmine();" class=aclick>Hard</a> ';
    buttons=buttons+'<a href="javascript:void(null);" onclick="javascript:record_klmine();" class=aclick>Record</a> ';
...
function menu_klmine(otd){
    ...
    if (ismine_klmine(otd.innerHTML)){
        var bljg='<button style="padding:0.5rem;width:3rem;" onclick="javascript:count_klmine(\''+otd.id+'\',0)">✓</button><br /><button style="padding:0.5rem;width:3rem;" onclick="javascript:count_klmine(\''+otd.id+'\',-2)">&nbsp;</button>';
    }
    else if (otd.style.backgroundColor==P_klmine_g.mask_bcolor) {
        var bljg='<button style="padding:0.5rem;width:3rem;" onclick="javascript:count_klmine(\''+otd.id+'\',0)">✓</button><br /><button style="padding:0.5rem;width:3rem;" onclick="javascript:count_klmine(\''+otd.id+'\',-1)">'+mine_character_global+'</button>';
    }
    else if (td_get_value_klmine(otd.id)>0 && iscleaned_klmine(otd.id)==false) {
        var bljg='<button style="padding:0.5rem;width:4rem;" onclick="javascript:open_klmine(\''+otd.id+'\')">✓+</button>';
    }
    else {return;}
