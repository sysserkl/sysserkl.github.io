...
function menu_more_cn_medicine_nl(){    
    ...
    var klmenu1=[
    '<span class="span_menu"><select id="select_sort_type_jsad_cn_medicine_nl" style="height:2rem;">'+col_name_list.join('\n')+'</select> <span class="aclick" onclick="'+blparent+'sort_cn_medicine_nl();">↑</span><span class="aclick" onclick="'+blparent+'sort_cn_medicine_nl(true);">↓</span></span>',    
    ];
