function olds_words_batch_today_words(rnd_words_num=0,cn_def_words_num=0){
    ...
    blhtml.innerHTML=bljg+button_temp_batch_add_enwc_b()+enwords_batch_div_b(words_searched_arr_global)+enwords_js_wiki_textarea_b(words_searched_arr_global)+'<p class="p_ignore_words" style="font-size:1rem;">忽略('+ignore_words.length+')：'+ignore_words.join(', ')+'</p>';
