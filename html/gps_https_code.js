...
function buttons_gps(){
    ...
    bljg=bljg+'<span class="aclick" onclick="javascript:run_times_global=0;run_gps_global=setInterval(record_write_gps,document.getElementById(\'input_second\').value*1000);">Start</span>';
    bljg=bljg+'<span class="aclick" onclick="javascript:clearInterval(run_gps_global);">Stop</span>';
    bljg=bljg+'<span class="aclick" onclick="javascript:record_clear_gps();">Clear Records</span>';
    bljg=bljg+'<span class="aclick" onclick="javascript:record_export_gps();">Export Records</span>';
    return bljg;
}
...
function record_export_gps(){
    ...
    odiv.innerHTML='<textarea>'+bljg+'</textarea><br /><a href="javascript:void(null);" onclick="javascript:this.parentNode.style.display=\'none\';">Close</a>';
}
