...
function menu_rndwords(){
    ...
    '<span class="span_menu" onclick="javascript:'+str_t+'if (confirm(\'是否更新版本？\')){service_worker_delete_b(\'pwa_rnd_enwords_store\',\'rnd_english_words_service_worker.js\');}">更新版本</span>',
    ];
