self.addEventListener('install', function(e) {
    e.waitUntil(
        caches.open('pwa_selenium_enwords_store').then(function(cache) {
            return cache.addAll([
            'selenium_enwords.htm',
            'selenium_enwords_code.js',            
    ...
    e.respondWith(
        caches.match(e.request).then(function(r) {
            ...
            return r || fetch(e.request).then(function(response) {
                return caches.open('pwa_selenium_enwords_store').then(function(cache) {
