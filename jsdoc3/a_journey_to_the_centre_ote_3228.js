...
"By Jules Verne",
"<b>[ Redactor's Note:</b> <i>Journey to the Centre of the Earth</i> is number <b>V002</b> in the Taves and Michaluk numbering of the works of Jules Verne. First published in England by Griffith and Farran, 1871, this edition is not a translation at all but a complete re-write of the novel, with portions added and omitted, and names changed. The most reprinted version, it is entered into Project Gutenberg for reference purposes only. A better translation is <i>A Journey into the Interior of the Earth</i> translated by Rev. F. A. Malleson, also available on Project Gutenberg.<b>]</b>",
"Table of Contents",
...
"The castle of Kronborg soon disappeared in the murky atmosphere, as well as the tower of Helsinborg, which raises its head on the Swedish Bank. And here the schooner began to feel in earnest the breezes of the Kattegat. The <i>Valkyrie</i> was swift enough, but with all sailing boats there is the same uncertainty. Her cargo was coal, furniture, pottery, woolen clothing, and a load of corn. As usual, the crew was small, five Danes doing the whole of the work.",
...
"On the eleventh day we sighted Cape Portland, over which towered Mount Myrdals Yokul, which, the weather being clear, we made out very readily. The cape itself is nothing but a huge mount of granite standing naked and alone to meet the Atlantic waves. The <i>Valkyrie</i> kept off the coast, steering to the westward. On all sides were to be seen whole \"schools\" of whales and sharks. After some hours we came in sight of a solitary rock in the ocean, forming a mighty vault, through which the foaming waves poured with intense fury. The islets of Westman appeared to leap from the ocean, being so low in the water as scarcely to be seen until you were right upon them. From that moment the schooner was steered to the westward in order to round Cape Reykjanes, the western point of Iceland.",
...
"[1] Thermometer (<i>thermos</i>, and <i>metron</i>, measure); an instrument for measuring the temperature of the air.—Manometer (<i>manos</i>,and <i>metron</i>, measure); an instrument to show the density or rarity of gases.—Chronometer (<i>chronos</i>. time, and <i>metros</i>, measure) a time measurer, or superior watch—Ruhmkorff's coil, an instrument for producing currents of induced electricity of great intensity. It consists of a coil of copper wire, insulated by being covered with silk, surrounded by another coil of fine wire, also insulated, in which a momentary current is induced when a current is passed through the inner coil from a voltaic battery. When the apparatus is in action, the gas becomes luminous, and produces a white and continued light. The battery and wire are carried in a leather bag, which the traveler fastens by a strap to his shoulders. The lantern is in front, and enables the benighted wanderer to see in the most profound obscurity. He may venture without fear of explosion into the midst of the most inflammable gases, and the lantern will burn beneath the deepest waters. H. D. Ruhmkorff, an able and learned chemist, discovered the induction coil. In 1864 he won the quinquennial French prize of £2,000 for this ingenious application of electricity—A voltaic battery, so called from Volta, its designer, is an apparatus consisting of a series of metal plates arranged in pairs and subjected to the action of saline solutions for producing currents of electricity.",
...
"\"No, Harry, my boy, certainly not. Go, leave me, I am very far from desiring your death. Take Hans with you. <i>I will go on alone.</i>\"",
...
"\"And at this stage of our journey, according to all known laws on the increase of heat, there should be here a temperature of <i>fifteen hundred degrees of Reaumur</i>.\"",
...
"The heat increases. I look at the thermometer, to my surprise it indicates—<i>The exact figure is here rubbed out in my manuscript.</i>",
...
"Jules Verne",
"*** END OF THIS PROJECT GUTENBERG EBOOK CENTRE OF THE EARTH ***",
"***** This file should be named 18857-h.htm or 18857-h.zip *****",
"This and all associated files of various formats will be found in:",
"http://www.gutenberg.org/1/8/8/5/18857/",
"Produced by Norm Wolcott",
