...
function one_link_gerenrate_rlater_b(idno,cslink,cstitle,csstrong=false,prgname='readlater',other_str='',with_li=true,show_host=false){    
    var bljg='';
    if (with_li){
        bljg=bljg+'<li>';
    }
    ...
    if (show_host){
        bljg=bljg+' <small>('+href2host_b(cslink)+')</small>';
    }
    bljg=bljg+other_str;
    if (with_li){
        bljg=bljg+'</li>';
